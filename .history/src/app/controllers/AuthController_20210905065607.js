...
class AuthController {
    ...
    pageSignup_email(req, res, next) {
        res.render('auth/signup_email',{error: res.locals.error})
   ...
   sendMail(req, res, next) {
        ...
        .then((accounts)=>{
            if(!accounts) { 
               ...
               res.redirect('/auth/pageCode')
                ...
                res.cookie('error','Account have been exist') = 'Account have been exist';           
            res.redirect('back') 
            }
        })
    ...
    sendAccount(req,res,next){
        Account.findOne({email : req.body.forgotEmail})
        .then((accounts)=>{
            if(accounts) { 
